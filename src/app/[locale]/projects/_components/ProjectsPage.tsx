...
import CardImageWithDetails from "../../_components/tools/CardImageWithDetails";
...
export default function ProjectsPage({
    ...
    useEffect(() => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`/api/getprojectslist?city=${dataid}&page=${page}`);
    ...
    return (  
        ...
        <div className="mx-auto container px-6 lg:px-8 mt-5">
            <h1 className="text-3xl truncate mb-5">{city} Egypt Real Estate</h1>
