...
export default function ProjectsTable(props:any){
    ...
    return (
        <tr className="py-4 pr-3 pl-4 text-sm whitespace-nowrap text-gray-900 sm:pl-0 hover:bg-ebLightGreen">
            <td className="py-4 pr-3 pl-4 text-sm whitespace-nowrap text-gray-900 sm:pl-0">
            <a
                data-fancybox="floorplans" 
                data-caption={`Projects`} 
                href={href}
                className="text-indigo-600 hover:text-indigo-900 "
            >
                <Image src={image} className="object-fit h-20 w-30" width={300} height={200} alt="Projects"/>
            </a>
            </td>
            <td className="px-3 py-4 text-sm whitespace-nowrap text-black ">
