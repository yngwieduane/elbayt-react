...
const propertyTypes = ['Apartment', 'Villa', 'Townhouse', 'Twinhouse', 'Penthouse', 'Duplex', 'Studio', 'Serviced Apartment', 'Chalet', 'Cabana', 'Cabin', 'Condo', 'Townhome', 'S Villa', 'Land', 'Beach House'];

const category = ['Residential', 'Commercial'];

const finishing = ['Fully Furnished', 'Semi Finished', 'Core and Shell', 'Fully finished with AC', 'Deluxe Finishing', 'Land'];
        ...
        <Sticky stickyClassName="" boundaryElement=".mainsidebar"  hideOnBoundaryHit={false}>
            <div className="p-4 grid grid-cols-1 border border-gray-300 rounded-md space-y-6 ">
                ...
                <div>
                    ...
                    <Label className="block text-lg font-medium text-gray-900">Category</Label>
                        <div className="relative mt-2">
                            <ListboxButton className="grid w-full cursor-default grid-cols-1 rounded-md bg-white py-2.5 pr-2 pl-3 text-left text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-lg">
                                <span className="col-start-1 row-start-1 truncate pr-6">{categories}</span>
                                <ChevronDown
                                    aria-hidden="true"
